...
*Clicking on an XLA operation in the Trace Viewer shows information, including a link to the corresponding operation in the HLO Graph Viewer tool.*

![Graph Viewer](images/trace_viewer_to_hlo_graph_2.png)
*Note the same XLA operation highlighted in the Graph Viewer, with its connections to other operations in the HLO graph.*
