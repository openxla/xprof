...
export const HLO_TOOLS = ['memory_viewer', 'graph_viewer'];
...
/** Primary tool endpoints that are authorized to consume and clear the cache invalidation flag */
export const PRIMARY_TOOL_ENDPOINTS = new Set([
  'overview_page',
  'trace_viewer',
  'raw_trace_viewer',
  'events_db',
