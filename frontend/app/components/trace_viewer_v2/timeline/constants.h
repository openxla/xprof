...
inline constexpr Pixel kRulerHeight = 24.0f;
...
inline constexpr ImU32 kMinimapSelectionBandColor = IM_COL32(59, 130, 246, 120);
inline constexpr ImU32 kMinimapSelectionBorderColor =
    IM_COL32(29, 78, 216, 255);
inline constexpr Pixel kMinimapDragSelectionThreshold = 3.0f;
