...
void DrawExpandCollapseButton(Timeline::Group& group, int group_index) {
...
Timeline::EventRect Timeline::CalculateEventRect(
...
Timeline::DeleteButtonLayout Timeline::GetDeleteButtonLayout(
