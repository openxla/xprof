...
struct FlameChartTimelineData {
  ...
  std::vector<uint32_t> entry_name_indices;
  ...
  // Map from event index to flow id that connects to this event.
  absl::flat_hash_map<int, uint64_t> flow_ids_by_event_index;
