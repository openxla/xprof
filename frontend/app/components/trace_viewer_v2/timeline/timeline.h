...
class Timeline {
 public:
  ...
  void set_minimap_drag_selection_for_test(float start_x, float current_x) {
    minimap_drag_mode_ = MinimapDragMode::kSelectRange;
    minimap_drag_start_x_ = start_x;
    minimap_selection_current_x_ = current_x;
    minimap_is_selecting_range_ = true;
  }
  bool minimap_is_selecting_range() const {
    return minimap_is_selecting_range_;
  }
  float minimap_selection_current_x() const {
    return minimap_selection_current_x_;
  }
 ...
 private:
  ...
  float minimap_selection_current_x_ = 0.0f;
  bool minimap_is_selecting_range_ = false;
