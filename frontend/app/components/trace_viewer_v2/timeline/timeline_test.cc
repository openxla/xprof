...
TEST(TimelineTest, CalculateOffsets) {
  ...
  // But since start_level is 3 for Group 2, maybe we should have 4 levels?
  // 0, 1 are in Group 0.
  // 2 is in Group 1.
  // 3 is in Group 2 (empty).
  // Let's resize events_by_level to 4 so visible_level_offsets has size 4.
