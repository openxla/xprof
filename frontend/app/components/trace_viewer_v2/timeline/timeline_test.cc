...
TEST_F(RealTimelineImGuiFixture, ClickPinButtonPinsAndUnpinsTrack) {
  FlameChartTimelineData data;
  data.entry_levels = {0};
  data.entry_total_times = {10.0};
  data.entry_self_times = {10.0};
  ...
  ImGuiIO& io = ImGui::GetIO();
  io.MousePos = ImVec2(timeline_.GetLabelWidth() - 25.0f, 135.0f);
  SimulateFrame();
  ...
  io.MousePos = ImVec2(timeline_.GetLabelWidth() - 25.0f, 105.0f);
  SimulateFrame();
