#ifndef XPROF_FRONTEND_APP_COMPONENTS_TRACE_VIEWER_V2_WEBGPU_RENDER_PLATFORM_H_
#define XPROF_FRONTEND_APP_COMPONENTS_TRACE_VIEWER_V2_WEBGPU_RENDER_PLATFORM_H_
...
#endif  // XPROF_FRONTEND_APP_COMPONENTS_TRACE_VIEWER_V2_WEBGPU_RENDER_PLATFORM_H_
