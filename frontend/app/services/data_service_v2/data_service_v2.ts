...
import {API_PREFIX, CAPTURE_PROFILE_API, CONFIG_API, DATA_API, GRAPH_TYPE_DEFAULT, GRAPHVIZ_PAN_ZOOM_CONTROL, HLO_MODULE_LIST_API, HOSTS_API, LOCAL_URL, PLUGIN_NAME, RUN_TOOLS_API, RUNS_API, USE_SAVED_RESULT, VERSION_API} from 'org_xprof/frontend/app/common/constants/constants';
