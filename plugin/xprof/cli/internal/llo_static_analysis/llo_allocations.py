...
_SPILL_FILL_PSEUDO_KINDS: types.MappingProxyType[int, str] = (
    types.MappingProxyType({
        llo_lite_pb2.PSEUDO_KIND_SPILL_TO_MEMORY: "SPILL_TO_MEMORY",
        llo_lite_pb2.PSEUDO_KIND_FILL_FROM_MEMORY: "FILL_FROM_MEMORY",
        llo_lite_pb2.PSEUDO_KIND_SPILL_TO_REGISTER: "SPILL_TO_REGISTER",
        llo_lite_pb2.PSEUDO_KIND_SPILL_TO_HBM: "SPILL_TO_HBM",
        llo_lite_pb2.PSEUDO_KIND_FILL_FROM_HBM: "FILL_FROM_HBM",
        llo_lite_pb2.PSEUDO_KIND_SPILL_TO_VIRTUAL: "SPILL_TO_VIRTUAL",
        llo_lite_pb2.PSEUDO_KIND_FILL_FROM_VIRTUAL: "FILL_FROM_VIRTUAL",
    })
)
...
def summarize(module: llo_lite_pb2.LloModuleProto) -> dict[str, object]:
...
def render_allocations_json(
    module: llo_lite_pb2.LloModuleProto, max_rows: int = 20
) -> str:
  """Renders a spill / allocation report as JSON."""
  payload = {
      "hlo_instruction_name": module.hlo_instruction_name,
      "summary": summarize(module),
      "allocations": extract_allocations(module),
      "spill_fill_instructions": extract_spill_fill_instructions(module)[
          :max_rows
      ],
  }
