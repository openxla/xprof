...
def iter_llo_modules(
    xspace: Any,
) -> Iterator[llo_lite_pb2.LloModuleProto]:
...
def find_llo_modules_for_op(
    xspace: Any, hlo_op: str
) -> list[llo_lite_pb2.LloModuleProto]:
...
def list_hlo_op_names(xspace: Any) -> list[str]:
