...
class DetectUnnecessaryConvertDynamicScaleToolTest(absltest.TestCase):
  ...
  def test_cli_entry_point_with_mocked_backend(self):
    ...
    mock_debug_info = mock.MagicMock()
    mock_proto_wrapper = mock.MagicMock()
    mock_proto_wrapper.hlo_module = proto
    mock_debug_info.hlo_proto = [mock_proto_wrapper]
    mock_debug_info.program_id = [12345]
