...
class CrossCuttingContractsTest(parameterized.TestCase):
  ...
  def test_x06_volume_guard_spill_to_file(self):
    ...
    wrapped = xprof_cli._wrap_with_logdir(_dummy_huge_tool)
    res_raw = wrapped()
    res = json.loads(res_raw)
  ...
  def test_x07_cache_freshness_in_place_swap(self):
    ...
    key1 = decorators._compute_path_fingerprint(temp_dir)
    ...
    key2 = decorators._compute_path_fingerprint(temp_dir)
