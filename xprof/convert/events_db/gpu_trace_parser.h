...
#ifndef THIRD_PARTY_XPROF_CONVERT_EVENTS_DB_GPU_TRACE_PARSER_H_
#define THIRD_PARTY_XPROF_CONVERT_EVENTS_DB_GPU_TRACE_PARSER_H_
...
// Ingests GPU device trace events from `device_trace` (e.g. "/device:GPU:0")
// and streams each parsed `Record` to `consumer`.
...
#endif  // THIRD_PARTY_XPROF_CONVERT_EVENTS_DB_GPU_TRACE_PARSER_H_
