...
#ifndef THIRD_PARTY_XPROF_CONVERT_EVENTS_DB_TPU_TRACE_PARSER_H_
#define THIRD_PARTY_XPROF_CONVERT_EVENTS_DB_TPU_TRACE_PARSER_H_
...
// Ingests TPU device trace events from `device_trace` (TensorCore, SparseCore,
// NonCore) and streams each parsed `Record` to `consumer`.
...
#endif  // THIRD_PARTY_XPROF_CONVERT_EVENTS_DB_TPU_TRACE_PARSER_H_
