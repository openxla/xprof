...
void CombineOpStats(
  ...
  // Combine Disaggregated Serving Stats.
  if (src.has_disaggregated_serving_stats()) {
    DisaggregatedServingStats* dst_stats =
        dst->mutable_disaggregated_serving_stats();
    const DisaggregatedServingStats& src_stats =
        src.disaggregated_serving_stats();
