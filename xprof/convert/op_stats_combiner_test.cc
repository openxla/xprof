...
TEST(CombineAllOpStatsTest, CombineDisaggregatedServingStats) {
  ...
  // Source OpStats 1
  auto* serving_stats_1 = src_op_stats_1.mutable_disaggregated_serving_stats();
  serving_stats_1->set_num_decode_steps(10);
  serving_stats_1->mutable_decode_step_time_us()->set_avg(100.0);

  // Source OpStats 2
  auto* serving_stats_2 = src_op_stats_2.mutable_disaggregated_serving_stats();
  ...
  const auto& dst_serving_stats = dst_op_stats.disaggregated_serving_stats();
