...
void SetDeviceDutyCycleAndIdleTime(const MetricsDbT& db,
  ...
  analysis->set_device_duty_cycle_high_confidence_percent(
      tsl::profiler::SafeDivide(
          db.busy_time_high_confidence_ps(),
          db.busy_time_high_confidence_ps() +
              db.idle_time_high_confidence_ps()) *
      100.0);
