...
const tsl::uint32 kDefaultGpuLocalCoreId = 1;
...
tsl::string DebugGenericStepBreakdown(const GenericStepBreakdown& generic) {
...
tsl::string DebugStepInfo(const StepInfoResult& step_info) {
  std::ostringstream out;
