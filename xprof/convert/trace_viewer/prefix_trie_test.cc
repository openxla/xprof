...
TEST(PrefixTrieTest, PrefixSearchOnEmptyTrie) {
  ...
  ASSERT_OK(trie.SaveAsLevelDbTable(file));
...
TEST(PrefixTrieTest, PrefixSearchOnTrieWithMultipleKeysMatchingPrefix) {
  PrefixTrie trie;
  trie.Insert("abc", "id00");
  ...
  auto results = LoadTrieAsLevelDbTableAndSearch(GetTempFilename(), "abc");
  ASSERT_OK(results);
  std::vector<PrefixSearchResult> expected_results = {
      {.key = "abc", .terminal_key_ids = {"id00"}},
...
TEST(PrefixTrieTest, PrefixSearchOnTrieWithMultipleKeysPrefixNotFound) {
  PrefixTrie trie;
  trie.Insert("abc", "id00");
  trie.Insert("abcd", "id01");
  trie.Insert("abce", "id02");
  ...
  auto results = LoadTrieAsLevelDbTableAndSearch(GetTempFilename(), "abd");
  ASSERT_OK(results);
  std::vector<PrefixSearchResult> expected_results = {};
  EXPECT_THAT(*results, UnorderedPointwise(PrefixSearchResultFieldsAreEqual(),
                                           expected_results));
...
TEST(PrefixTrieTest, PrefixSearchOnTrieWithMultipleKeysEmptyPrefix) {
  PrefixTrie trie;
  trie.Insert("abc", "id00");
  trie.Insert("abcd", "id01");
  trie.Insert("abce", "id02");
  ...
  auto results = LoadTrieAsLevelDbTableAndSearch(GetTempFilename(), "");
  ASSERT_OK(results);
  std::vector<PrefixSearchResult> expected_results = {
      {.key = "abc", .terminal_key_ids = {"id00"}},
      {.key = "abcd", .terminal_key_ids = {"id01", "id04"}},
...
TEST(PrefixTrieTest, PrefixSearchOnTrieWithMultipleKeysPrefixIsAnExactMatch) {
  PrefixTrie trie;
  trie.Insert("abc", "id00");
  trie.Insert("abcd", "id01");
  trie.Insert("abce", "id02");
  ...
  auto results = LoadTrieAsLevelDbTableAndSearch(GetTempFilename(), "abce");
  ASSERT_OK(results);
  std::vector<PrefixSearchResult> expected_results = {
      {.key = "abce", .terminal_key_ids = {"id02"}}};
  EXPECT_THAT(*results, UnorderedPointwise(PrefixSearchResultFieldsAreEqual(),
