...
class UnifiedGraphViewerProcessor : public UnifiedProfileProcessor {
 public:
  ...
  absl::StatusOr<std::string> Map(
    ...
    return absl::UnimplementedError(
        "Map not implemented for UnifiedGraphViewerProcessor");
  }
  ...
  absl::Status Reduce(
    ...
    return absl::UnimplementedError(
        "Reduce not implemented for UnifiedGraphViewerProcessor");
  }
};
