...
#ifndef THIRD_PARTY_XPROF_CONVERT_UNIFIED_OP_PROFILE_PROCESSOR_H_
#define THIRD_PARTY_XPROF_CONVERT_UNIFIED_OP_PROFILE_PROCESSOR_H_
...
class UnifiedOpProfileProcessor : public BaseOpStatsProcessor {
 public:
  explicit UnifiedOpProfileProcessor(
...
#endif  // THIRD_PARTY_XPROF_CONVERT_UNIFIED_OP_PROFILE_PROCESSOR_H_
