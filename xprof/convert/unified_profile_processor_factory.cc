...
UnifiedProfileProcessorFactory& UnifiedProfileProcessorFactory::GetInstance() {
  static auto* instance = new UnifiedProfileProcessorFactory();
  return *instance;
}

void UnifiedProfileProcessorFactory::Register(
    absl::string_view tool_name,
    absl::AnyInvocable<std::unique_ptr<UnifiedProfileProcessor>(
