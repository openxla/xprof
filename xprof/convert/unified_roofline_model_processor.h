...
#ifndef THIRD_PARTY_XPROF_CONVERT_UNIFIED_ROOFLINE_MODEL_PROCESSOR_H_
#define THIRD_PARTY_XPROF_CONVERT_UNIFIED_ROOFLINE_MODEL_PROCESSOR_H_
...
class UnifiedRooflineModelProcessor : public BaseOpStatsProcessor {
 public:
  explicit UnifiedRooflineModelProcessor(
...
#endif  // THIRD_PARTY_XPROF_CONVERT_UNIFIED_ROOFLINE_MODEL_PROCESSOR_H_
