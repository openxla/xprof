...
#ifndef THIRD_PARTY_XPROF_CONVERT_UNIFIED_UTILIZATION_VIEWER_PROCESSOR_H_
#define THIRD_PARTY_XPROF_CONVERT_UNIFIED_UTILIZATION_VIEWER_PROCESSOR_H_
...
class UnifiedUtilizationViewerProcessor : public UnifiedProfileProcessor {
 public:
  explicit UnifiedUtilizationViewerProcessor(
...
#endif  // THIRD_PARTY_XPROF_CONVERT_UNIFIED_UTILIZATION_VIEWER_PROCESSOR_H_
