...
// generations was a directly addressed structure with 32 banks, each containing
// 512 entries for 32-bits of data – a total of 64KB of data. Each bank could
// read and write a 32-bit value and the LDS incorporates logic for conflict
// detection and scheduling, a sophisticated crossbar and swizzle unit along
// with atomic execution units."
//
...
std::optional<GpuFlopCapabilities> GetAmdFlopCapsPerCuPerCycle(
  ...
  static const auto& kTable = *new absl::btree_map<absl::string_view,
                                                   GpuFlopCapabilities>{
